  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        default:
          'size-full px-8 pt-4 pb-24 text-base w-full max-w-none',
        demo: 'size-full px-8 pt-4 pb-24 text-base w-full max-w-none',
        fullWidth: 'size-full px-8 pt-4 pb-24 text-base w-full',
        none: '',

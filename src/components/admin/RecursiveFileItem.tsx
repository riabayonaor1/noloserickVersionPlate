...
import { ChevronDown, ChevronRight, File, Folder, Edit, Trash, GripVertical, ExternalLink } from 'lucide-react';
import { cn } from '@/lib/utils';
import { Button } from '@/components/ui/button';
import { Draggable, Droppable } from 'react-beautiful-dnd';

export const RecursiveFileItem = ({ 
  item, 
  index, 
  level = 0, 
  onOpenModal, 
      ...
      {(provided, snapshot) => (
        ...
        >
          ...
          {isFolder && hasChildren && isOpen && (
            <Droppable droppableId={item.id} type="FILE_ITEM">
              {(provided, snapshot) => (
                <div
                  ref={provided.innerRef}
